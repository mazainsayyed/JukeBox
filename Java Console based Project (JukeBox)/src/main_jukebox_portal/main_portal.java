        ...
        while (option == 1)
        {
            ...
            switch (ch)                 //1st switchcase
            {
                    ...
                    while (k == 1)
                    {
                        ...
                        switch (cho)                        //inner switch 2nd case
                        {
                            case 1:                                  // START OF CASE 1 TO DISPLAY ALL AVAILABLE SONGS
                            {
                                ...
                                System.out.println();
                                System.out.println();
                                //System.out.println(" Enter your song Id which you want to play  ▶️");
                ...
                case 2:
                {
                    ...
                    System.out.println("   Enter User Password  must contain special character ");
                    String password1 = sc.next();

                    try {
                        boolean s = (password1.contains("_") || (password1.contains("#")) || (password1.contains("1"))
